...
{
    public static ProjectionQueryFlow1<T0> Query<T0>(this World world)
    {
    ...
    public static ProjectionQueryFlow2<T0, T1> Query<T0, T1>(this World world)
    {
        QueryDescription description = new QueryDescription();
    ...
    public static ProjectionQueryFlow3<T0, T1, T2> Query<T0, T1, T2>(this World world)
    {
        QueryDescription description = new QueryDescription();
    ...
    public static ProjectionQueryFlow4<T0, T1, T2, T3> Query<T0, T1, T2, T3>(this World world)
    {
        QueryDescription description = new QueryDescription();
    ...
    public static ProjectionQueryFlow5<T0, T1, T2, T3, T4> Query<T0, T1, T2, T3, T4>(this World world)
    {
        QueryDescription description = new QueryDescription();
    ...
    public static ProjectionQueryFlow6<T0, T1, T2, T3, T4, T5> Query<T0, T1, T2, T3, T4, T5>(this World world)
    {
        QueryDescription description = new QueryDescription();
    ...
    public static ProjectionQueryFlow7<T0, T1, T2, T3, T4, T5, T6> Query<T0, T1, T2, T3, T4, T5, T6>(this World world)
    {
        QueryDescription description = new QueryDescription();
    ...
    public static ProjectionQueryFlow8<T0, T1, T2, T3, T4, T5, T6, T7> Query<T0, T1, T2, T3, T4, T5, T6, T7>(this World world)
    {
        QueryDescription description = new QueryDescription();
