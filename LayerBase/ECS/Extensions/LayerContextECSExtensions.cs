...
public static class LayerContextECSExtensions
{
    ...
    public static ProjectionQueryFlow1<T1> Query<T1>(this ILayerContext ILayerContext)
    {
        return ECSWorld(ILayerContext).Query<T1>();
    }
    ...
    public static ProjectionQueryFlow2<T1, T2> Query<T1, T2>(this ILayerContext ILayerContext)
    {
        return ECSWorld(ILayerContext).Query<T1, T2>();
    }
    ...
    public static ProjectionQueryFlow3<T1, T2, T3> Query<T1, T2, T3>(this ILayerContext ILayerContext)
    {
        return ECSWorld(ILayerContext).Query<T1, T2, T3>();
    }
    ...
    public static ProjectionQueryFlow4<T1, T2, T3, T4> Query<T1, T2, T3, T4>(this ILayerContext ILayerContext)
    {
        return ECSWorld(ILayerContext).Query<T1, T2, T3, T4>();
    }
    ...
    public static ProjectionQueryFlow5<T1, T2, T3, T4, T5> Query<T1, T2, T3, T4, T5>(this ILayerContext ILayerContext)
    {
        return ECSWorld(ILayerContext).Query<T1, T2, T3, T4, T5>();
    }
