...
public static class LayerQueryExtensions
{
    /// <summary>
    /// 查询同时拥有 T1 组件的实体。
    /// </summary>
    ...
    public static ProjectionQueryFlow1<T1> Query<T1>(this Layer layer)
    {
        return ECSWorld(layer).Query<T1>();
    }
    ...
    public static ProjectionQueryFlow2<T1, T2> Query<T1, T2>(this Layer layer)
    {
        return ECSWorld(layer).Query<T1, T2>();
    }
    ...
    public static ProjectionQueryFlow3<T1, T2, T3> Query<T1, T2, T3>(this Layer layer)
    {
        return ECSWorld(layer).Query<T1, T2, T3>();
    }
    ...
    public static ProjectionQueryFlow4<T1, T2, T3, T4> Query<T1, T2, T3, T4>(this Layer layer)
    {
        return ECSWorld(layer).Query<T1, T2, T3, T4>();
    }
    ...
    public static ProjectionQueryFlow5<T1, T2, T3, T4, T5> Query<T1, T2, T3, T4, T5>(this Layer layer)
    {
        return ECSWorld(layer).Query<T1, T2, T3, T4, T5>();
    }
    ...
    public static ProjectionQueryFlow6<T1, T2, T3, T4, T5, T6> Query<T1, T2, T3, T4, T5, T6>(this Layer layer)
    {
        return ECSWorld(layer).Query<T1, T2, T3, T4, T5, T6>();
    }
    ...
    public static ProjectionQueryFlow7<T1, T2, T3, T4, T5, T6, T7> Query<T1, T2, T3, T4, T5, T6, T7>(this Layer layer)
    {
        return ECSWorld(layer).Query<T1, T2, T3, T4, T5, T6, T7>();
    }
