...
public partial class World
{
    ...
    public void Remove<T0, T1, T2, T3, T4, T5, T6>(Entity entity)
    {
        ...
        {
            var newSignature =
                Signature.Remove(oldArchetype.Signature, Component<T0, T1, T2, T3, T4, T5, T6>.Signature);
            newArchetype = GetOrCreate(newSignature);
        }
    ...
    public void Remove<T0, T1, T2, T3, T4, T5, T6, T7>(Entity entity)
    {
        ...
        {
            var newSignature =
                Signature.Remove(oldArchetype.Signature, Component<T0, T1, T2, T3, T4, T5, T6, T7>.Signature);
            newArchetype = GetOrCreate(newSignature);
        }
    ...
    public void Remove<T0, T1, T2, T3, T4, T5, T6, T7, T8>(Entity entity)
    {
        ...
        if (!TryGetArchetype(spanBitSet.GetHashCode(), out var newArchetype))
        {
            var newSignature = Signature.Remove(oldArchetype.Signature,
