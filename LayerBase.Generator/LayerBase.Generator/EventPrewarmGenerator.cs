...
public sealed class EventPrewarmGenerator : IIncrementalGenerator
{
    ...
    {
        var sanitizedAssemblyName = new string(assemblyName.Where(char.IsLetterOrDigit).ToArray());
        ...
        builder.AppendLine();
        builder.AppendLine("namespace LayerBase.Generated;");
        builder.AppendLine();
        builder.AppendLine($"internal static class LayerBasePrewarmInitializer_{sanitizedAssemblyName}");
        builder.AppendLine("{");
