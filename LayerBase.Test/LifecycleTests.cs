...
public class LifecycleTests
{
    ...
    public void Lifecycle_Phases_Execute_In_Correct_Order()
    {
        ...
        int updateA = _trace.IndexOf("Update_A");
        int updateB = _trace.IndexOf("Update_B");
    ...
    private class LifecycleTestService : IService
    {
        ...
        public LifecycleTestService(List<string> trace) => _trace = trace;

        public void ConfigureServices(IServiceCollection services)
        {
            // 注册顺序：A 先于 B
            services.AddSingleton<ManagerA>(new ManagerA(_trace));
            services.AddSingleton<ManagerB>(new ManagerB(_trace));
        }
    }
    ...
    public partial class ManagerA : ILayerContext, IAutoSubscribe, IInitializable, IUpdate
    {
        ...
        public ManagerA(List<string> trace) => _trace = trace;

        public void AutoBind(Layer l) => _trace.Add("AutoBind_A");
        public IEnumerable<EventDependency> GetEventDependencies() => Enumerable.Empty<EventDependency>();
        public IEnumerable<Type> GetSubscribedEvents() => Enumerable.Empty<Type>();

        public void Initialize() => _trace.Add("Init_A");
        public void Update() => _trace.Add("Update_A");
    }
    ...
    public partial class ManagerB : ILayerContext, IAutoSubscribe, IInitializable, IUpdate
    {
        private readonly List<string> _trace;
        public int LayerIndex { get; set; }
        public ManagerB(List<string> trace) => _trace = trace;

        public void AutoBind(Layer l) => _trace.Add("AutoBind_B");
        public IEnumerable<EventDependency> GetEventDependencies() => Enumerable.Empty<EventDependency>();
        public IEnumerable<Type> GetSubscribedEvents() => Enumerable.Empty<Type>();

        public void Initialize() => _trace.Add("Init_B");
        public void Update() => _trace.Add("Update_B");
    }
}
