...
public class TimeSchedulerTests
{
    ...
    public void Basic_Timer_Once()
    {
        ...
        var options = new TimeSchedulerOptions(0.1f, 10, 64, 1.0f, 1024, 64, TimerRepeatMode.Once, TimerCatchUpPolicy.SkipMissed);
    ...
    {
        var options = new TimeSchedulerOptions(0.1f, 100, 64, 10.0f, 1024, 64, TimerRepeatMode.FixedDelay, TimerCatchUpPolicy.SkipMissed);
        var scheduler = new TimeScheduler<int>(options);
        var sink = new MockSink();
    ...
    {
        var options = new TimeSchedulerOptions(0.1f, 100, 64, 10.0f, 1024, 64, TimerRepeatMode.FixedRate, TimerCatchUpPolicy.SkipMissed);
        var scheduler = new TimeScheduler<int>(options);
        var sink = new MockSink();
