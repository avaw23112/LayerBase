...
public class ActorGeneratorTests
{
    ...
    public void Actor_behaviour_attribute_emits_plain_registration_without_behaviour_type_metadata()
    {
        ...
        Assert.That(generated,
            Does.Contain("builder.AddBehaviour<global::Sample.EnemyActor, global::Sample.DamageEvent>("));
    ...
    public void Actor_call_behaviour_generates_call_route_registration()
    {
        ...
        Assert.That(generated,
            Does.Contain(
                "builder.AddCallBehaviour<global::Sample.EnemyActor, global::Sample.GetHpRequest, global::Sample.GetHpResponse>("));
